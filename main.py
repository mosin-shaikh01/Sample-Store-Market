...
st.set_page_config(page_title="Super Martket", page_icon=":bar_chart:", layout="wide" )

st.title(":bar_chart: Sample Store Market")
st.markdown('<style>div.block-container{padding-top:2.5rem}</style>',unsafe_allow_html=True)

fl = st.file_uploader(":file_folder: Upload a file (Please add file with containing columns like Order Date, Segment, Country, City, State, Region, Category, Sub-Category, Sales,Quantity, Profit)", type=(["csv","txt","xlsx","xls"]))
...
#Filter the data based onRegion, State and City
...
with st.expander("View Data"):
    st.write(filtered_df.iloc[:500,1:20:2].style.background_gradient(cmap ="Purples"))
